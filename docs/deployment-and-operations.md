...
CLI version=1.8.7-fengwk.3
extension version=1.0.24
source revision=fengwk/OpenCLI@df693d324e97a1201cebb7d246c34009b49eaa27
```
...
当前 fork Release（tag `fork-v1.8.7-fengwk.3`，CLI `1.8.7-fengwk.3` + extension `1.0.24`）：
