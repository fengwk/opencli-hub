...
CLI version=1.8.7-fengwk.8
extension version=1.0.29
source revision=fengwk/OpenCLI@6613555ec64ebeada47237f4d0c13476542175c2
```
...
当前 fork Release（tag `fork-v1.8.7-fengwk.8`，CLI `1.8.7-fengwk.8` + extension `1.0.29`）：
